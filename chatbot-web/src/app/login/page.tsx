    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-xl font-bold text-primary-foreground">C</div>
        ...
        <CardContent className="space-y-3">
          ...
          <Button variant="secondary" className="w-full" onClick={() => signIn('credentials', { email: 'demo@example.com', password: 'demo' })}>
            Continue with Demo
          </Button>
        </CardContent>
      </Card>
